...
internal data class SpectatingMapImpl(
    ...
    @SerialName("radiant_ward_purchase_cooldown") override val radiantWardPurchaseCooldown: Long,
    @SerialName("dire_ward_purchase_cooldown") override val direWardPurchaseCooldown: Long,
    @SerialName("roshan_state") override val roshanState: String,
    @SerialName("roshan_state_end_seconds") override val roshanStateEndSeconds: Long,
    @SerialName("radiant_win_chance") override val radiantWinChance: Long,
) : SpectatingMap
