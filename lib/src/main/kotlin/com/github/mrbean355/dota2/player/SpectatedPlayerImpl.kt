...
internal data class SpectatedPlayerImpl(
    ...
    @SerialName("hero_healing") override val heroHealing: Int,
    @SerialName("tower_damage") override val towerDamage: Int,
    ...
    @SerialName("water_runes_activated") override val waterRunesActivated: Int,
    @SerialName("bounty_runes_activated") override val bountyRunesActivated: Int,
    ...
    @SerialName("damage_received_pre_reduction_physical") override val damageReceivedPreReductionPhysical: Int,
    @SerialName("damage_received_pre_reduction_magical") override val damageReceivedPreReductionMagical: Int,
    @SerialName("damage_received_pre_reduction_pure") override val damageReceivedPreReductionPure: Int,
    @SerialName("damage_received_post_reduction_physical") override val damageReceivedPostReductionPhysical: Int,
    @SerialName("damage_received_post_reduction_magical") override val damageReceivedPostReductionMagical: Int,
    @SerialName("damage_received_post_reduction_pure") override val damageReceivedPostReductionPure: Int,
    @SerialName("damage_outgoing_pre_reduction_physical") override val damageOutgoingPreReductionPhysical: Int,
    @SerialName("damage_outgoing_pre_reduction_magical") override val damageOutgoingPreReductionMagical: Int,
    @SerialName("damage_outgoing_pre_reduction_pure") override val damageOutgoingPreReductionPure: Int,
    @SerialName("damage_outgoing_post_reduction_physical") override val damageOutgoingPostReductionPhysical: Int,
    @SerialName("damage_outgoing_post_reduction_magical") override val damageOutgoingPostReductionMagical: Int,
    @SerialName("damage_outgoing_post_reduction_pure") override val damageOutgoingPostReductionPure: Int,
) : SpectatedPlayer
